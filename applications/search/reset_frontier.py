...
from datamodel.search.Haodoz1Qiancw1Xinhew1_datamodel import Haodoz1Qiancw1Xinhew1ProjectionLink
...
@Deleter(Haodoz1Qiancw1Xinhew1ProjectionLink)
@Getter(Haodoz1Qiancw1Xinhew1ProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(Haodoz1Qiancw1Xinhew1ProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(Haodoz1Qiancw1Xinhew1ProjectionLink, l)
